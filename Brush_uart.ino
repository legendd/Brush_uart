...
/* #1 */
const int Brush1_In1 = 22;  // brush #1
const int Brush1_In2 = 24;  // brush #1
const int Motor1_In3 = 26; // motor #1
const int Motor1_In4 = 28; // motor #1
const int EN1_A = 4;      // Enable Brush(#1)
const int EN1_B = 5;      // Enable motor(#1)
const int led = 10;
/* #2 */
const int Brush2_In1 = 30; // brush #2
const int Brush2_In2 = 32; // brush #2
const int Motor2_In3 = 34; // motor #2
const int Motor2_In4 = 36; // motor #2
...
void serialEvent()
{
  ...
  if(incomingByte == '1'){
    Wire.beginTransmission(SLAVE_ADDRESS); // transmit to device #1
